...
class DataCrm
{
        ...
        try {
            ...
            $data_datacrm =
                [
                    ...
                    'cf_1052'          => $data['pais_cliente'], //País del Cliente
                    ...
                    'cf_1783'          =>  !empty($data['Zona']) ? str_replace('-',' ', $data['Zona']) : 'PENDIENTE', //Zonificación REQUIRED
    ...
    /**
     * Busca una cotización en datacrm por su ID.
     *
     * @param $id
     *
     * @return array
    ...
    /**
     * Actualiza un cotización en datacrm.
     *
     * @param $data
     *
     * @return array|null
